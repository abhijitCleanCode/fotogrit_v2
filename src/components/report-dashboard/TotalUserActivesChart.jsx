...
import { useGetTotalUserActivesQuery } from "@/services/api/dashboardApiSlice";
import { CurrencyFormat } from "@/helpers/CurrencyFormat";

const TotalUserActivesChart = ({ timeFilter }) => {
  const { data, isLoading } = useGetTotalUserActivesQuery({
    period: timeFilter,
  });
  ...
  return (
    <div className="mt-5">
      <h3 className="text-3xl font-bold">Total Active Users</h3>
      <h5 className="">
        <em>
          {timeFilter === "weekly" ? (
...
export default TotalUserActivesChart;
