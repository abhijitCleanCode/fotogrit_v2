...
import { useGetTotalUserSignupsQuery } from "@/services/api/dashboardApiSlice";
import { CurrencyFormat } from "@/helpers/CurrencyFormat";

const TotalUserSignupChart = ({ timeFilter }) => {
  console.log("TotalUserSignupChart", timeFilter);
  const { data, isLoading } = useGetTotalUserSignupsQuery({
    period: timeFilter,
  });
  ...
  return (
    <div className="mt-5">
      <h3 className="text-3xl font-bold">Total  New User Sign Ups</h3>
      <h5 className="">
        <em>
          {timeFilter === 'weekly' ? (
...
export default TotalUserSignupChart;
