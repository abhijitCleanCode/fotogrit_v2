...
import { useGetTotalFaceRecognitionsQuery } from "@/services/api/dashboardApiSlice";
import { CurrencyFormat } from "@/helpers/CurrencyFormat";

const TotalFaceRecognitionsChart = ({ timeFilter }) => {
  const { data, isLoading } = useGetTotalFaceRecognitionsQuery({
    period: timeFilter,
  });
  ...
  return (
    <div className="mt-5">
      <h3 className="text-3xl font-bold">Total Face Recognitions</h3>
      <h5 className="">
        <em>
          {timeFilter === "weekly" ? (
...
export default TotalFaceRecognitionsChart;
