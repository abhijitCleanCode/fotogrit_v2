                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <SelectDropdown
                      ...
                      errValidation={errors}
                      setSearchQueryOption={setSearchQueryOptionUsers}
                      infiniteScroll
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <SelectDropdown
                      ...
                      errValidation={errors}
                      infiniteScroll
                      setSearchQueryOption={setSearchQueryEventType}
                      totalPageOptions={totalPageOptionEventType}
                      setPageOption={setPageEventType}
                    />
                  )}
                />
              </div>
