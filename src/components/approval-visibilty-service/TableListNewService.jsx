...
import { Checkbox, MultiSelect, SelectDropdown } from "@/components/form-input";
import {
  ...
  const handleVisibility = async (e) => {
    ...
    try {
      ...
      const updateData = {
        ...
        users: selectedVisibility?.value === "public" ? [] : [selectedVisibility.value],
      };
        ...
        <form>
          <div className="flex flex-col gap-4">
            <SelectDropdown
              ...
              setSelectedValue={setSelectedVisibility}
              infiniteScroll
              ...
              disabled={selectedVisibility?.value === "public"}
            />

            <div className="flex items-start justify-start gap-2">
              <div className="w-4 h-4">
                <Checkbox
                  name="checkPublicVisibility"
                  checked={selectedVisibility?.value === "public"}
                  onChange={() => {
