...
const OfficialList = (props) => {
  ...
  const [pageOptionOfficials, setPageOptionOfficials] = useState(1);
  const [searchQueryOptionOfficials, setSearchQueryOptionOfficials] = useState('');
  const debouncedSearchOptionOfficials = useDebounce(searchQueryOptionOfficials, 200);
  const { data: officialData } = useGetOptionsOfficialsQuery({
    searchTerm: debouncedSearchOptionOfficials,
    page: 1,
  });
  ...
  const totalPageOptionOfficials = officialData?.meta?.total_page;
 ...
 const totalPageOptionCustomerData = customers?.meta?.total_page;
  ...
  const officialAddForm = isOpenNewData && (
         <FormAddOfficialList
          ...
          setPageOptionOfficials={setPageOptionOfficials}
          totalPageOptionOfficials={totalPageOptionOfficials}
          setSearchQueryOptionOfficials={setSearchQueryOptionOfficials}
