...
import { Input, SelectDropdown, SelectInput } from "@/components/form-input";
...
const FormDetailOfficialList = (props) => {
  const {
    ...
    setPageOptionOfficials,
    totalPageOptionOfficials,
    setSearchQueryOptionOfficials,
  } = props;
  ...
  if (customerData?.data) {
    const findCustomer = optionsCustomers.find(
      ...
      <form onSubmit={handleUpdate}>
        <div className="grid grid-flow-row-dense grid-cols-1 gap-2 sm:grid-cols-3 gap-y-2">
          ...
          <SelectInput
            ...
            infiniteScroll
            setPageOption={setPageOptionOfficials}
            setSearchQueryOption={setSearchQueryOptionOfficials}
            totalPageOptions={totalPageOptionOfficials}
          />
