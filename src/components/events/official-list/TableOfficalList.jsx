...
const TableOfficialList = (props) => {
  ...
  const activeButton = !isAdmin || !eventGroupID || !filterSelectedOfficialTeam;
  return (
    <div>
      {isError ? (
            ...
            <table className="min-w-full border-collapse table-auto">
              ...
              <thead>
                <tr className="bg-white  border-b border-gray-200">
                  ...
                  <th
                    className="min-w-96 px-6 py-3 text-left text-sm font-extrabold text-black cursor-pointer"
