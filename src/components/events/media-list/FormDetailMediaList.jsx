...
const FormDetailMediaList = (props) => {
  ...
  const preorderOptions = [
    { value: "PreOrder001", label: "PreOrder001" },
    { value: "PreOrder002", label: "PreOrder002" },
    { value: "PreOrder003", label: "PreOrder003" },
  ];
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-4">
            ...
            <span
              className={`text-sm ${
                isPublic ? "text-black font-bold" : "text-gray-500"
              }`}
            >
              Public
            </span>
          ...
          <div className="flex items-center gap-4">
            ...
            <span
              className={`text-sm ${
                isPreorder ? "text-black font-bold" : "text-gray-500"
              }`}
            >
              Pre Order
            </span>
              ...
              <div className="w-48">
                <Select
                  ...
                  value={preorderOptions.find(
                    (option) => option.value === selectedPreorder
                  )}
                  options={preorderOptions}
                  onChange={(option) => setSelectedPreorder(option.value)}
                  isDisabled={!isAccess?.can_edit}
                  placeholder="Select Pre Order"
                  styles={{
                    control: (provided) => ({
                      ...provided,
                      border: "none",
                      borderRadius: "12px",
                      backgroundColor: !isAccess?.can_edit
                        ? "rgb(0 0 0 / 0.26)"
                        : "rgb(209 213 219 / 0.5)",
      ...
      <form onSubmit={handleUpdate}>
        <div className="mt-5 grid grid-flow-row-dense grid-cols-1 gap-4 sm:grid-cols-3 lg:grid-cols-4 gap-y-2">
          <Input
            type="text"
            label="Media Code"
            name="mediaCode"
